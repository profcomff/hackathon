...
3. **Условия участия в Хакатоне**
    ...
    3. Все команды проходят отбор Организатором на основании поданной Заявки. Команды, претендующие на участие в Конкурсном треке, дополнительно выполняют отборочное задание, опубликованное в Группе Хакатона ВК. Для команд Свободного трека требования к отбору ниже, однако факт подачи Заявки не гарантирует участие в Хакатоне.
...
5. **Треки участия**
    ...
    3. **Свободный трек** — открытый формат без публичной защиты перед Жюри, предусматривающий:
        * регистрацию без выполнения отборочного задания;
