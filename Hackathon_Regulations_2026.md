# Регламент Хакатона {Идея. Код. Релиз} 2026
...
1. **Термины и определения** 
    ...
    3. Команда Хакатона – группа студентов и аспирантов московских и иных российских вузов в количестве от 3 до 6 человек, работающая над одним проектом в рамках хакатона. Каждый Участник может входить в состав только одной Команды.
    ...
    7. Участники – студенты и аспиранты московских и иных российских вузов, подавшие заявку на участие в рамках одной Команды.
    ...
    9. Жюри – группа лиц, утвержденных Организатором, осуществляющая оценку результатов работы Команд Конкурсного трека и определяющая Победителей и Призеров Хакатона.
    ...
    11. Конкурсный трек – соревновательный формат участия в Хакатоне с отбором команд, оценкой экспертным Жюри и призовым фондом.
    12. Свободный трек – открытый формат участия в Хакатоне без публичной защиты перед Жюри. Команды работают над своим проектом при поддержке менторов и партнёров Хакатона.
...
2. **Общие положения**
    ...
    4. Организатор имеет право вносить изменения в настоящий Регламент. Изменения вступают в силу с даты их опубликования.
    ...
    6. Хакатон проводится в рамках проекта «IT-Прорыв: лаборатория социальных и технологических инноваций», который реализуется при поддержке ФАДМ Росмолодежь (Росмолодежь.Гранты).
    ...
    9. Отправка Заявки на участие в Хакатоне и последующая регистрация на площадке подразумевают согласие Участника со всеми пунктами настоящего Регламента, а также согласие на обработку персональных данных в соответствии с разделом 14 настоящего Регламента.
    10. Цели проведения Хакатона:
        * Развитие навыков командной работы и создания IT-проектов у студентов российских вузов;
        * Разработка технологических решений для развития студенческих IT-сообществ и улучшения студенческой жизни;
        * Создание прототипов сервисов, которые могут быть интегрированы в проекты студенческих сообществ — в том числе в веб-приложение «Твой ФФ!», разработанное командой Viribus Team для студентов Физического факультета МГУ;
        * Привлечение талантливых разработчиков в команду Viribus Team и развитие студенческого IT-сообщества Viribus Unitis;
        * Формирование сети студенческих IT-специалистов, объединённых общей задачей улучшения студенческой жизни.
    11. Участие в Хакатоне бесплатное.
    12. Организатор оставляет за собой право делать исключения из правил настоящего Регламента в индивидуальных случаях по своему усмотрению, включая, но не ограничиваясь: прием несовершеннолетних участников, изменение сроков подачи заявок для отдельных команд, изменение требований к составу команд при наличии объективных обстоятельств.
...
3. **Условия участия в Хакатоне**
    ...
    3. Для участия в Хакатоне все команды проходят отбор на основании питч-презентации проекта, которую необходимо загрузить при подаче Заявки. Команды с наиболее высокими результатами отбора получают место в Конкурсном треке; команды, показавшие достаточный уровень, но не прошедшие в Конкурсный трек, могут быть зачислены в Свободный трек. Факт подачи Заявки не гарантирует участие в Хакатоне.
    ...
    5. Состав Команды Участников должен быть от 3 до 6 (шести) Участников.
    ...
    7. Задача каждой Команды Хакатона – представить Прототип решения одного из предложенных кейсов или Прототип собственного решения по направлениям деятельности Организатора. Прототип должен быть реализован исключительно в виде веб-приложения с использованием веб-технологий и быть доступным через веб-браузер. Нативные приложения для мобильных устройств или операционных систем не допускаются к участию. Допускается реализация в формате Telegram Mini App при наличии полноценного пользовательского интерфейса. Telegram-боты без графического интерфейса (только команды и текст) к участию не принимаются.
...
4. **Сроки проведения Хакатона**
    1. Мероприятия Хакатона проводятся с 21 марта 2026 года по 22 марта 2026 года.
    2. Регистрация на Хакатон закрывается в 23:59 (МСК) 15 марта 2026 г. После завершения регистрации Организатор объявляет итоговые списки команд, прошедших отбор.
    3. Команды, прошедшие отбор на Хакатон, обязаны пройти регистрацию на площадке 21 марта 2026 г. до 11:00. Если команда не зарегистрируется на площадке, она не будет допущена к участию.
    4. После завершения Хакатона, в течение согласованного Организатором времени, будет проводиться защита и оценка результатов Конкурсного трека с участием Жюри, пройдёт подведение итогов и награждение.

5. **Треки участия**
    1. Хакатон проводится в двух форматах — Конкурсном треке и Свободном треке.
    2. **Конкурсный трек** — соревновательный формат с ограниченным числом команд, предусматривающий:
        * отборочный этап: команды выполняют отборочное задание, по результатам которого Организатор формирует список участников трека;
        * работу над проектом в течение всего хакатона при поддержке менторов;
        * финальную защиту Прототипа перед экспертным Жюри;
        * оценку по установленным критериям и определение призовых мест;
        * вручение призов победителям и призёрам.
    3. **Свободный трек** — открытый формат без публичной защиты перед Жюри, предусматривающий:
        * отбор на основании той же питч-презентации, что и для Конкурсного трека, с более низкой планкой требований;
        * работу над проектом с поддержкой менторов в течение всего хакатона;
        * дополнительные активности и консультации при участии партнёров Хакатона (при наличии);
        * образовательные активности на площадке.
    4. По итогам хакатона наиболее сильные команды Свободного трека могут быть рекомендованы менторами для участия в финальной защите Конкурсного трека.
    5. При подаче Заявки команда указывает желаемый трек. Организатор оставляет за собой право предложить команде участие в альтернативном треке по результатам отбора.

6. **Порядок проведения Хакатона**
    1. В ходе Хакатона Участники создают Прототип. Команды Конкурсного трека проводят презентацию Прототипа членам Жюри в сроки, установленные Организатором.
    ...
    4. Участники самостоятельно обеспечивают наличие в период проведения Хакатона необходимых им для создания Прототипа средств разработки.
    5. Компенсация Участникам каких-либо расходов, связанных с участием в Хакатоне, не производится.
    6. Для организации презентаций Прототипов и оценки Прототипов членами Жюри Организатор обеспечивает соответствующую информационную среду.

7. **Требования к Участникам и Командам Хакатона**
    1. Участником может быть физическое лицо старше 18 лет на дату подачи Заявки, являющееся студентом или аспирантом российского вуза в соответствии с п. 1.7 настоящего Регламента.
    ...
    6. Команды реализуют Прототипы по принципу открытого исходного кода. Участники обязуются опубликовать Прототип в открытый доступ в сети Интернет неограниченному количеству лиц под лицензией MIT License (при условии упоминания авторства и лицензии в работе).
    7. Требования к названию Команды:
...
8. **Правила дистанционного участия**
    ...
    4. Все члены Команды обязаны присутствовать на открытии Хакатона. Для Конкурсного трека обязательным является очное присутствие на финальной защите Прототипа. Для участников, которые не могут присутствовать очно (дистанционные участники), Организатор не предоставляет специального оборудования или каналов для дистанционного участия. Ответственность за включение дистанционных участников в работу команды лежит полностью на самой Команде.
...
9. **Технические требования к Прототипам**
    ...
    4. Нативные приложения для мобильных устройств (iOS, Android) или настольных операционных систем (Windows, macOS, Linux) не принимаются к рассмотрению. Telegram-боты без пользовательского интерфейса также не допускаются.
...
10. **Критерии оценки**
    1. Оценка Прототипов осуществляется только для команд Конкурсного трека и проходит в два этапа: предварительный онлайн-этап и финальная очная защита.
    2. На предварительном онлайн-этапе Организатор оценивает проработанность концепции, применение продуктовых методологий, качество дизайна и прототипа интерфейса, а также техническую архитектуру решения.
    3. На финальной очной защите Жюри оценивает актуальность и обоснованность задачи, качество предложенного решения, реализацию прототипа и техническую состоятельность, потенциал для развития и масштабирования, а также качество командной презентации.
    4. Команды Свободного трека не оцениваются Жюри и призовых мест не занимают.

11. **Призы и награждение**
...
12. **Права на РИД (Результаты Интеллектуальной Деятельности)**
